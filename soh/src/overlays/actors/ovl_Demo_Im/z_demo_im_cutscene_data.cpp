...
static CutsceneData D_8098786C[] = {
    ...
    CS_NPC_ACTION_LIST(44, 3),
        CS_NPC_ACTION(0x0001, 0, 145, 0x0000, 0x0000, 0x0000, UINT32_C(-97), 6, 169, UINT32_C(-97), 6, 169, 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 145, 615, 0x0000, 0x0000, 0x0000, UINT32_C(-97), 6, 169, UINT32_C(-97), 6, 169, 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0003, 615, 1906, 0x0000, 0x0000, 0x0000, UINT32_C(-97), 6, 169, UINT32_C(-97), 6, 169, 0.0f, 0.0f, 0.0f),
    CS_NPC_ACTION_LIST(49, 1),
        CS_NPC_ACTION(0x0001, 0, 3000, 0x0000, 0x0000, 0x0000, UINT32_C(-22), 0, UINT32_C(-55), UINT32_C(-22), 0, UINT32_C(-55), 0.0f, 0.0f, 0.0f),
    CS_LIGHTING_LIST(2),
