...
static CutsceneData D_80AB431C[] = {
    ...
    CS_NPC_ACTION_LIST(40, 3),
        CS_NPC_ACTION(0x0001, 0, 145, 0x0000, 0x0000, 0x0000, UINT32_C(-97), 6, UINT32_C(-167), UINT32_C(-97), 6, UINT32_C(-167), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 145, 431, 0x0000, 0x0000, 0x0000, UINT32_C(-97), 6, UINT32_C(-167), UINT32_C(-97), 6, UINT32_C(-167), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0003, 431, 1399, 0x0000, 0x0000, 0x0000, UINT32_C(-97), 6, UINT32_C(-167), UINT32_C(-97), 6, UINT32_C(-167), 0.0f, 0.0f, 0.0f),
