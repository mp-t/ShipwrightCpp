...
static CutsceneData D_8099010C[] = {
    ...
    CS_NPC_ACTION_LIST(43, 3),
        CS_NPC_ACTION(0x0001, 0, 165, 0x0000, 0x0000, 0x0000, UINT32_C(-98), 6, UINT32_C(-169), UINT32_C(-98), 6, UINT32_C(-169), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 165, 466, 0x0000, 0x0000, 0x0000, UINT32_C(-98), 6, UINT32_C(-169), UINT32_C(-98), 6, UINT32_C(-169), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0003, 466, 3001, 0x0000, 0x0000, 0x0000, UINT32_C(-98), 6, UINT32_C(-169), UINT32_C(-98), 6, UINT32_C(-169), 0.0f, 0.0f, 0.0f),
    CS_SCENE_TRANS_FX(0x0001, 590, 607),
    CS_SCENE_TRANS_FX(0x0005, 617, 647),
    CS_SCENE_TRANS_FX(0x0001, 875, 905),
    CS_NPC_ACTION_LIST(49, 1),
        CS_NPC_ACTION(0x0001, 0, 3000, 0x0000, 0x0000, 0x0000, UINT32_C(-98), 0, 98, UINT32_C(-98), 0, 98, 0.0f, 0.0f, 0.0f),
    CS_NPC_ACTION_LIST(62, 1),
        CS_NPC_ACTION(0x0004, 0, 3000, 0x0000, 0x0000, 0x0000, UINT32_C(-35), 97, UINT32_C(-60), UINT32_C(-35), 97, UINT32_C(-60), 0.0f, 0.0f, 0.0f),
