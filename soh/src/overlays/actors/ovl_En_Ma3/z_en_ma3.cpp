...
u16 func_80AA2AA0(GlobalContext* globalCtx, Actor* thisv);
s16 func_80AA2BD4(GlobalContext* globalCtx, Actor* thisv);

void func_80AA2E54(EnMa3* thisv, GlobalContext* globalCtx);
s32 func_80AA2EC8(EnMa3* thisv, GlobalContext* globalCtx);
s32 func_80AA2F28(EnMa3* thisv);
...
u16 func_80AA2AA0(GlobalContext* globalCtx, Actor* thisx) {
    ...
    s16* timer1ValuePtr; // weirdness with thisv necessary to match
...
void EnMa3_UpdateEyes(EnMa3* thisv) {
    if ((!func_80AA2F28(thisv)) && (DECR(thisv->blinkTimer) == 0)) {
        thisv->eyeIndex += 1;
        if (thisv->eyeIndex >= 3) {
...
void EnMa3_ChangeAnim(EnMa3* thisv, s32 index) {
...
void EnMa3_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (func_80AA2EC8(thisv, globalCtx)) {
        case 0:
            EnMa3_ChangeAnim(thisv, ENMA3_ANIM_0);
            thisv->actionFunc = func_80AA3200;
            break;
        case 1:
            EnMa3_ChangeAnim(thisv, ENMA3_ANIM_0);
            thisv->actionFunc = func_80AA3200;
...
void EnMa3_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    EnMa3_UpdateEyes(thisv);
    thisv->actionFunc(thisv, globalCtx);
    func_80AA2E54(thisv, globalCtx);
    func_800343CC(globalCtx, &thisv->actor, &thisv->unk_1E0.unk_00, (f32)thisv->collider.dim.radius + 150.0f,
...
void EnMa3_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, const Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if ((limbIndex == MALON_ADULT_LIMB_LEFT_HAND) && (thisv->skelAnime.animation == &gMalonAdultStandStillAnim)) {
...
void EnMa3_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_DrawFlexOpa(globalCtx, thisv->skelAnime.skeleton, thisv->skelAnime.jointTable, thisv->skelAnime.dListCount,
                          EnMa3_OverrideLimbDraw, EnMa3_PostLimbDraw, thisv);
