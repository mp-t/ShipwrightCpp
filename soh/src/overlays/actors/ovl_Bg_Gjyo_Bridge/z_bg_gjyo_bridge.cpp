...
void func_808787A4(BgGjyoBridge* thisv, GlobalContext* globalCtx);
void BgGjyoBridge_TriggerCutscene(BgGjyoBridge* thisv, GlobalContext* globalCtx);
void BgGjyoBridge_SpawnBridge(BgGjyoBridge* thisv, GlobalContext* globalCtx);
...
void BgGjyoBridge_Init(Actor* thisx, GlobalContext* globalCtx) {
    BgGjyoBridge* thisv = (BgGjyoBridge*)thisx;
    s32 pad;
...
void BgGjyoBridge_TriggerCutscene(BgGjyoBridge* thisv, GlobalContext* globalCtx) {
    ...
    if (CHECK_QUEST_ITEM(QUEST_MEDALLION_SPIRIT) && CHECK_QUEST_ITEM(QUEST_MEDALLION_SHADOW) &&
        ...
        thisv->actionFunc = BgGjyoBridge_SpawnBridge;
    }
}
...
void BgGjyoBridge_SpawnBridge(BgGjyoBridge* thisv, GlobalContext* globalCtx) {
    if ((globalCtx->csCtx.state != CS_STATE_IDLE) && (globalCtx->csCtx.npcActions[2] != NULL) &&
        ...
        thisv->dyna.actor.draw = BgGjyoBridge_Draw;
