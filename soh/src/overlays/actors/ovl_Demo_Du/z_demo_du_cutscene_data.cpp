...
static CutsceneData D_8096C1A4[] = {
    ...
    CS_NPC_ACTION_LIST(31, 5),
        CS_NPC_ACTION(0x0001, 0, 546, 0x0000, 0x0000, 0x0000, 0, 216, UINT32_C(-10), 0, 216, UINT32_C(-10), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 546, 547, 0x0000, 0x0000, 0x0000, 0, 216, UINT32_C(-10), 0, 216, UINT32_C(-10), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0004, 547, 616, 0x0000, 0x0000, 0x0000, 0, 216, UINT32_C(-10), 0, 216, UINT32_C(-10), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 616, 667, 0x0000, 0x0000, 0x0000, 0, 216, UINT32_C(-10), 0, 82, 0, 0.0f, -2.627451f, 0.0f),
    ...
    CS_NPC_ACTION_LIST(41, 3),
        CS_NPC_ACTION(0x0001, 0, 170, 0x0000, 0x0000, 0x0000, 98, 6, UINT32_C(-169), 98, 6, UINT32_C(-169), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 170, 465, 0x0000, 0x0000, 0x0000, 98, 6, UINT32_C(-169), 98, 6, UINT32_C(-169), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0003, 465, 2915, 0x0000, 0x0000, 0x0000, 98, 6,UINT32_C( -169), 98, 6, UINT32_C(-169), 0.0f, 0.0f, 0.0f),
    CS_NPC_ACTION_LIST(49, 1),
        CS_NPC_ACTION(0x0001, 0, 3000, 0x0000, 0x0000, 0x0000, 0, UINT32_C(-16), UINT32_C(-121), 0, UINT32_C(-16), UINT32_C(-121), 0.0f, 0.0f, 0.0f),
    ...
    CS_NPC_ACTION_LIST(39, 1),
        CS_NPC_ACTION(0x0001, 0, 3000, 0x0000, 0x0000, 0x0000, 0, 0, UINT32_C(-2), 0, 0, UINT32_C(-2), 0.0f, 0.0f, 0.0f),
    CS_SCENE_TRANS_FX(0x0001, 805, 835),
    CS_NPC_ACTION_LIST(62, 1),
        CS_NPC_ACTION(0x0004, 0, 3000, 0x0000, 0x0000, 0x0000, 32, 80, UINT32_C(-51), 32, 80, UINT32_C(-51), 0.0f, 0.0f, 0.0f),
