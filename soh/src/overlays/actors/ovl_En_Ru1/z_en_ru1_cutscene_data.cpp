...
static CutsceneData D_80AF0880[] = {
    ...
    CS_PLAYER_ACTION_LIST(10),
        CS_PLAYER_ACTION(0x0027, 0, 50, 0x0000, 0x6C16, 0x0000, 12, UINT32_C(-340), UINT32_C(-2810), 12, UINT32_C(-340), UINT32_C(-2810), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0003, 50, 70, 0x0000, 0x6C16, 0x0000, 12, UINT32_C(-340), UINT32_C(-2810), 12, UINT32_C(-340), UINT32_C(-2810), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0005, 70, 109, 0x0000, 0x6C16, 0x0000, 12, UINT32_C(-340), UINT32_C(-2810), 12, UINT32_C(-340), UINT32_C(-2810), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0002, 109, 135, 0x0000, 0x6C16, 0x0000, 12, UINT32_C(-340), UINT32_C(-2810), 100, UINT32_C(-340), UINT32_C(-2991), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0005, 135, 199, 0x0000, 0x6C16, 0x0000, 100, UINT32_C(-340), UINT32_C(-2991), 100, UINT32_C(-340), UINT32_C(-2991), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0003, 199, 219, 0x0000, 0x6C16, 0x0000, 100, UINT32_C(-340), UINT32_C(-2991), 100, UINT32_C(-340), UINT32_C(-2991), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0005, 219, 259, 0x0000, 0x6C16, 0x0000, 100, UINT32_C(-340), UINT32_C(-2991), 100, UINT32_C(-340), UINT32_C(-2991), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0003, 259, 276, 0x0000, 0x6C16, 0x0000, 100, UINT32_C(-340), UINT32_C(-2991), 100, UINT32_C(-340), UINT32_C(-2991), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0002, 276, 297, 0x0000, 0x6C16, 0x0000, 100, UINT32_C(-340), UINT32_C(-2991), 182, UINT32_C(-340), UINT32_C(-3132), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0005, 297, 843, 0x0000, 0x6C16, 0x0000, 182, UINT32_C(-340), UINT32_C(-3132), 182, UINT32_C(-340), UINT32_C(-3132), 1.1393037E-29f, 0.0f, 1.4E-45f),
    CS_NPC_ACTION_LIST(63, 4),
        CS_NPC_ACTION(0x0002, 0, 178, 0x0000, 0xEC16, 0x0000, 127, UINT32_C(-340), UINT32_C(-3041), 127, UINT32_C(-340), UINT32_C(-3041), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_NPC_ACTION(0x0003, 178, 245, 0x0000, 0x6C16, 0x0000, 127, UINT32_C(-340), UINT32_C(-3041), 127, UINT32_C(-340), UINT32_C(-3041), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_NPC_ACTION(0x0004, 245, 260, 0x0000, 0x6C16, 0x0000, 127, UINT32_C(-340), UINT32_C(-3041), 127, UINT32_C(-340), UINT32_C(-3041), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_NPC_ACTION(0x0005, 260, 396, 0x0000, 0x6C16, 0x0000, 127, UINT32_C(-340), UINT32_C(-3041), 127, UINT32_C(-340), UINT32_C(-3041), 1.1393037E-29f, 0.0f, 1.4E-45f),
    CS_MISC_LIST(1),
...
static CutsceneData D_80AF10A4[] = {
    ...
    CS_PLAYER_ACTION_LIST(3),
        CS_PLAYER_ACTION(0x0005, 0, 272, 0x0000, 0xC000, 0x0000, UINT32_C(-1085), UINT32_C(-1025), UINT32_C(-3347), UINT32_C(-1085), UINT32_C(-1025), UINT32_C(-3347), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0003, 272, 292, 0x0000, 0xC000, 0x0000, UINT32_C(-1085), UINT32_C(-1025), UINT32_C(-3347), UINT32_C(-1085), UINT32_C(-1025), UINT32_C(-3347), 1.1393037E-29f, 0.0f, 1.4E-45f),
        CS_PLAYER_ACTION(0x0005, 292, 777, 0x0000, 0xC000, 0x0000, UINT32_C(-1085), UINT32_C(-1025), UINT32_C(-3347), UINT32_C(-1085), UINT32_C(-1025), UINT32_C(-3347), 1.1393037E-29f, 0.0f, 1.4E-45f),
    CS_MISC_LIST(1),
    ...
    CS_NPC_ACTION_LIST(66, 3),
        CS_NPC_ACTION(0x0001, 0, 40, 0x0000, 0x4000, 0x0000, UINT32_C(-1352), UINT32_C(-969), UINT32_C(-3341), UINT32_C(-1352), UINT32_C(-969), UINT32_C(-3341), 0.0f, 0.0f, 1.4E-45f),
        CS_NPC_ACTION(0x0002, 40, 213, 0x0000, 0x4000, 0x0000, UINT32_C(-1352), UINT32_C(-969), UINT32_C(-3341), UINT32_C(-1360), UINT32_C(-969), UINT32_C(-3343), 0.0f, 0.0f, 1.4E-45f),
        CS_NPC_ACTION(0x0003, 213, 1000, 0x0000, 0x4000, 0x0000, UINT32_C(-1360), UINT32_C(-969), UINT32_C(-3343), UINT32_C(-1360), UINT32_C(-969), UINT32_C(-3343), 0.0f, 0.0f, 1.4E-45f),
    CS_NPC_ACTION_LIST(48, 1),
        CS_NPC_ACTION(0x0002, 0, 90, 0x0000, 0x0000, 0x0000, UINT32_C(-1360), UINT32_C(-963), UINT32_C(-3343), UINT32_C(-1360), UINT32_C(-963), UINT32_C(-3343), 0.0f, 0.0f, 0.0f),
    CS_NPC_ACTION_LIST(48, 2),
        CS_NPC_ACTION(0x0002, 90, 211, 0x0000, 0x0000, 0x0000, UINT32_C(-1352), UINT32_C(-922), UINT32_C(-3341), UINT32_C(-1352), UINT32_C(-922), UINT32_C(-3341), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0006, 211, 311, 0x0000, 0x0000, 0x0000, UINT32_C(-1352), UINT32_C(-922), UINT32_C(-3341), UINT32_C(-1352), UINT32_C(-922), UINT32_C(-3341), 0.0f, 0.0f, 0.0f),
    CS_NPC_ACTION_LIST(62, 3),
        CS_NPC_ACTION(0x0004, 0, 210, 0x0000, 0x0000, 0x0000, UINT32_C(-1065), UINT32_C(-972), UINT32_C(-3305), UINT32_C(-1065), UINT32_C(-978), UINT32_C(-3305), 0.0f, -0.028571429f, 0.0f),
        CS_NPC_ACTION(0x0004, 210, 220, 0x8000, 0x0000, 0x0000, UINT32_C(-1065), UINT32_C(-978), UINT32_C(-3305), UINT32_C(-1065), UINT32_C(-973), UINT32_C(-3344), 0.0f, 0.5f, 0.0f),
        CS_NPC_ACTION(0x0004, 220, 410, 0x0000, 0x0000, 0x0000, UINT32_C(-1065), UINT32_C(-973), UINT32_C(-3344), UINT32_C(-1065), UINT32_C(-976), UINT32_C(-3344), 0.0f, -0.015789473f, 0.0f),
    CS_TEXT_LIST(6),
        CS_TEXT_NONE(0, 162),
    ...
    CS_CAM_AT_LIST(91, 1299),
        ...
        CS_CAM_AT(CS_CMD_STOP, 0x00, 30, 60.906673f, -1401, -1094, UINT32_C(-3347), 0x652E),
