...
CutsceneData D_808BCE20[] = {
    ...
    CS_PLAYER_ACTION_LIST(2),
        CS_PLAYER_ACTION(0x0002, 0, 33, 0x54B2, 0x0000, 0x0000, 2614, 0, UINT32_C(-451), 2808, 0, UINT32_C(-559), 5.878788f, 0.0f, -5.878788f),
        CS_PLAYER_ACTION(0x0004, 33, 42, 0x5945, 0x0000, 0x0000, 2808, 0, UINT32_C(-559), 2857, 0, UINT32_C(-594), 5.4444447f, 0.0f, -5.4444447f),
    ...
    CS_NPC_ACTION_LIST(46, 1),
        CS_NPC_ACTION(0x0001, 0, 3000, 0x0000, 0x0000, 0x0000, 0, UINT32_C(-41), UINT32_C(-28), 0, UINT32_C(-41), UINT32_C(-28), 0.0f, 0.0f, 0.0f),
    CS_NPC_ACTION_LIST(62, 4),
        CS_NPC_ACTION(0x0001, 0, 1, 0x0000, 0x0000, 0x0000, 2668, 46, UINT32_C(-490), 2668, 46, UINT32_C(-490), 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0004, 1, 50, 0x5479, 0x0000, 0x0000, 2668, 46, UINT32_C(-490), 2890, 43, UINT32_C(-612), 4.5306125f, -0.06122449f, -4.5306125f),
        CS_NPC_ACTION(0x0004, 50, 100, 0x505C, 0x0000, 0x0000, 2890, 43, UINT32_C(-612), 3109, 121, UINT32_C(-705), 4.38f, 1.56f, -4.38f),
        CS_NPC_ACTION(0x0001, 100, 2084, 0x0000, 0x0000, 0x0000, 3109, 121, UINT32_C(-705), 3109, 121, UINT32_C(-705), 0.0f, 0.0f, 0.0f),
    CS_PLAY_BGM_LIST(1),
...
CutsceneData D_808BD2A0[] = {
    ...
    CS_NPC_ACTION_LIST(46, 1),
        CS_NPC_ACTION(0x0001, 0, 3000, 0x0000, 0x0000, 0x0000, 0, UINT32_C(-27), 26, 0, UINT32_C(-27), 26, 0.0f, 0.0f, 0.0f),
    CS_CAM_EYE_LIST(0, 1091),
