...
void DemoGt_Destroy(Actor* thisx, GlobalContext* globalCtx) {
    DemoGt* thisv = (DemoGt*)thisx;

    if ((thisv->dyna.actor.params == 1) || (thisv->dyna.actor.params == 2)) {
...
void func_8097DAC8(DemoGt* thisv, GlobalContext* globalCtx, Vec3f* spawnerPos) {
    Vec3f pos;
    Vec3f velocity;
    f32 temp_f0;
    s16 angle;
...
void func_8097DD28(DemoGt* thisv, GlobalContext* globalCtx, Vec3f* spawnerPos) {
    Vec3f pos;
    Vec3f velocity;
    f32 temp_f0;
    s16 angle;
...
void func_8097DF70(DemoGt* thisv, GlobalContext* globalCtx, Vec3f* spawnerPos) {
    Vec3f pos;
    Vec3f velocity;
    f32 temp_f0;
    s16 angle;
...
void func_8097E824(DemoGt* thisv, s32 arg1) {
    s16 phi_a1;
    s16 phi_a2;
    s16 phi_a3;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
    Vec3s* unk16C = &thisv->unk_16C;
    s32 pad;
    f32 tempf3;
    f32 tempf2;
    f32 tempf1;
...
void func_8097ED64(DemoGt* thisv, GlobalContext* globalCtx, s32 actionIdx) {
    func_8097E744(thisv, globalCtx, actionIdx);
    func_8097E824(thisv, actionIdx);
}
...
u8 func_8097EE44(DemoGt* thisv, GlobalContext* globalCtx, s32 updateMode, s32 drawConfig, const CollisionHeader* colHeader) {
    ...
    if (func_8097ED94()) {
        ...
        func_8097EDD8(thisv, globalCtx, colHeader);
        return true;
    } else {
...
void func_8097EEA8_Init0(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;

    func_8097EE44(thisv, globalCtx, 0, 1, NULL);
}

void func_8097EF00(DemoGt* thisv, GlobalContext* globalCtx) {
...
void func_8097EF34(DemoGt* thisv, GlobalContext* globalCtx) {
}

void func_8097EF40(DemoGt* thisv, GlobalContext* globalCtx) {
    u16 frames = globalCtx->csCtx.frames;
    s32 pad1[3];
    Vec3f dustPos;
...
void func_8097F0AC(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f sp38;
    s16 pad1[3];
    Vec3f sp24;
    ...
    if ((frames == 140) || (kREG(1) == 19)) {
        sp38.x = thisv->dyna.actor.world.pos.x + 260.0f;
        sp38.y = thisv->dyna.actor.world.pos.y + 340.0f;
        sp38.z = thisv->dyna.actor.world.pos.z + 45.0f;
        DemoGt_SpawnExplosionWithSound(globalCtx, &sp38, 2.0f);
    }

    if (frames == 176) {
        sp24.x = thisv->dyna.actor.world.pos.x + 260.0f;
        sp24.y = thisv->dyna.actor.world.pos.y + 840.0f;
        sp24.z = thisv->dyna.actor.world.pos.z + 45.0f;
        DemoGt_SpawnExplosionWithSound(globalCtx, &sp24, 2.0f);
    }
}

void func_8097F19C(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097EF34(thisv, globalCtx);
    func_8097EF40(thisv, globalCtx);
    func_8097F0AC(thisv, globalCtx);
}

void func_8097F1D8(DemoGt* thisv) {
    f32 temp_v0 = thisv->unk_172;

    thisv->unk_174 = (temp_v0 * ((kREG(64) * 0.001f) + 0.048f)) + (kREG(72) + 10.0f);
    thisv->unk_172 += thisv->unk_174;

    if (thisv->unk_172 > (s16)(kREG(73) + 0x250)) {
        thisv->unk_172 = kREG(73) + 0x250;
    }
}

void func_8097F280(DemoGt* thisv, GlobalContext* globalCtx) {
    s32* unk178 = thisv->unk_178;
    s32* unk188 = thisv->unk_188;
    s32* unk198 = thisv->unk_198;
    f32 temp_f0;
...
void func_8097F3EC(DemoGt* thisv, GlobalContext* globalCtx) {
    if (func_8097E704(globalCtx, 2, 1)) {
        thisv->updateMode = 8;
    }
}

void DemoGt_Update0(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097F280(thisv, globalCtx);
    func_8097E824(thisv, 1);
    func_8097F19C(thisv, globalCtx);
    func_8097F3EC(thisv, globalCtx);
    DemoGt_PlayEarthquakeSfx();
    DemoGt_Rumble(globalCtx);
    func_8097EF00(thisv, globalCtx);
}

void DemoGt_Update8(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097F280(thisv, globalCtx);
    func_8097F1D8(thisv);
    func_8097ED64(thisv, globalCtx, 1);
    func_8097F19C(thisv, globalCtx);
    DemoGt_PlayEarthquakeSfx();
    DemoGt_Rumble(globalCtx);
    func_8097EF00(thisv, globalCtx);
...
void DemoGt_Draw1(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad;
    ...
    spC6 = thisv->unk_172;
    spC0 = fabsf(spC6 * (std::numbers::pi_v<float> / 0x8000));
    spBC = kREG(71);
    ...
    unk198 = thisv->unk_198;
    unk188 = thisv->unk_188;
    unk178 = thisv->unk_178;
...
void func_8097F904_Init1(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;
    func_8097EE44(thisv, globalCtx, 1, 2, &gTowerCollapseCsCollapsedStructureInnerCol);
}

void func_8097F960(DemoGt* thisv, GlobalContext* globalCtx) {
}

void func_8097F96C(DemoGt* thisv, GlobalContext* globalCtx) {
    ...
    if (((frames > 1059) && (frames < 1062)) || kREG(1) == 17) {
        ...
        pos.y = thisv->dyna.actor.world.pos.y + 612.0f;
...
void func_8097FA1C(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
...
void func_8097FAFC(DemoGt* thisv, GlobalContext* globalCtx) {
...
void func_8097FC1C(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
...
void func_8097FCE4(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f vec;
    u16 frames = globalCtx->csCtx.frames;

    if (frames == 0x1F7 || kREG(1) == 4) {
        vec.x = thisv->dyna.actor.world.pos.x + 300.0f;
        vec.y = thisv->dyna.actor.world.pos.y + 560.0f;
        vec.z = thisv->dyna.actor.world.pos.z - 377.0f;
        DemoGt_SpawnExplosionWithSound(globalCtx, &vec, 2.0f);
    }
}

void func_8097FD70(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097F960(thisv, globalCtx);
    func_8097F96C(thisv, globalCtx);
    func_8097FA1C(thisv, globalCtx);
    func_8097FAFC(thisv, globalCtx);
    func_8097FC1C(thisv, globalCtx);
    func_8097FCE4(thisv, globalCtx);
}

void func_8097FDDC(DemoGt* thisv, GlobalContext* globalCtx) {
    s32* unk178 = thisv->unk_178;
    s32* unk198 = thisv->unk_198;
...
void func_8097FED8(DemoGt* thisv, GlobalContext* globalCtx) {
    if (func_8097E704(globalCtx, 2, 2)) {
        thisv->updateMode = 9;
    }
}

void DemoGt_Update1(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097FDDC(thisv, globalCtx);
    func_8097E824(thisv, 2);
    func_8097FD70(thisv, globalCtx);
    func_8097FED8(thisv, globalCtx);
}

void DemoGt_Update9(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097FDDC(thisv, globalCtx);
    func_8097ED64(thisv, globalCtx, 2);
    func_8097FD70(thisv, globalCtx);
}

void DemoGt_Draw2(DemoGt* thisv, GlobalContext* globalCtx) {
    GraphicsContext* gfxCtx = globalCtx->state.gfxCtx;
    s32* unk198;
    s32* unk178;
    s32 pad;
...
void func_80980110_Init2(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;
    func_8097EE44(thisv, globalCtx, 2, 3, &gTowerCollapseCsCollapsedStructureOuterCol);
}

void func_8098016C(DemoGt* thisv, GlobalContext* globalCtx) {
}

void func_80980178(DemoGt* thisv, GlobalContext* globalCtx) {
}

void func_80980184(DemoGt* thisv, GlobalContext* globalCtx) {
    static Actor* cloudRing = NULL;
    s32 pad[4];
    Vec3f pos;
    Actor* actor;
    ...
    if ((globalCtx->csCtx.frames > 1027) && (globalCtx->csCtx.frames < 1031)) {
        pos.x = thisv->dyna.actor.world.pos.x;
        pos.y = thisv->dyna.actor.world.pos.y + 247.0f;
        pos.z = thisv->dyna.actor.world.pos.z;
...
void func_80980218(DemoGt* thisv, GlobalContext* globalCtx) {
    static Actor* cloudRing = NULL;
    s32 pad[4];
    Vec3f pos;
    Actor* actor;
    ...
    if ((globalCtx->csCtx.frames > 997) && (globalCtx->csCtx.frames < 1001)) {
        pos.x = thisv->dyna.actor.home.pos.x;
        pos.y = thisv->dyna.actor.home.pos.y + 38.0f;
        pos.z = thisv->dyna.actor.home.pos.z;
...
void func_809802AC(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
...
void func_8098036C(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* world = &thisv->dyna.actor.world.pos;
...
void func_80980430(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
...
void func_80980504(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
...
void func_809805D8(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* homePos = &thisv->dyna.actor.home.pos;
...
void func_809806B8(DemoGt* thisv, GlobalContext* globalContext) {
    s32 pad[3];
    Vec3f dustPos;
...
void func_8098078C(DemoGt* thisv, GlobalContext* globalContext) {
    s32 pad[3];
    Vec3f dustPos;
    u16 frames = globalContext->csCtx.frames;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
...
void func_8098085C(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f sp28;
    u16 frames = globalCtx->csCtx.frames;
    Vec3f* pos = &thisv->dyna.actor.world.pos;
...
void func_809809C0(DemoGt* thisv, GlobalContext* globalCtx2) {
...
void func_80980AD4(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[4];
    Vec3f pos;
    u16 frames = globalCtx->csCtx.frames;

    if ((frames == 477) || (kREG(2) == 1)) {
        pos.x = thisv->dyna.actor.world.pos.x + 790.0f;
        pos.y = thisv->dyna.actor.world.pos.y + 60.0f;
        pos.z = thisv->dyna.actor.world.pos.z + 23.0f;

        func_8097DAC8(thisv, globalCtx, &pos);
        DemoGt_PlayExplosion2Sfx(globalCtx, &pos);
    }
}

void func_80980B68(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[4];
    Vec3f pos;
    u16 frames = globalCtx->csCtx.frames;

    if ((frames == 317) || (kREG(3) == 1)) {
        pos.x = thisv->dyna.actor.world.pos.x + 980.0f;
        pos.y = thisv->dyna.actor.world.pos.y + 410.0f;
        pos.z = thisv->dyna.actor.world.pos.z - 177.0f;
        func_8097DD28(thisv, globalCtx, &pos);
        DemoGt_PlayExplosion2Sfx(globalCtx, &pos);
    }
}

void func_80980BFC(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[4];
    Vec3f pos;
    u16 frames = globalCtx->csCtx.frames;
    ...
    if ((frames == 740) || (kREG(4) == 1)) {
        ...
        func_8097DF70(thisv, globalCtx, &pos);
        DemoGt_PlayExplosion2Sfx(globalCtx, &pos);
    }
}

void func_80980C90(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8098016C(thisv, globalCtx);
    func_80980178(thisv, globalCtx);
    func_80980184(thisv, globalCtx);
    func_80980218(thisv, globalCtx);
    func_809802AC(thisv, globalCtx);
    func_8098036C(thisv, globalCtx);
    func_80980430(thisv, globalCtx);
    func_80980504(thisv, globalCtx);
    func_809805D8(thisv, globalCtx);
    func_809806B8(thisv, globalCtx);
    func_8098078C(thisv, globalCtx);
    func_8098085C(thisv, globalCtx);
    func_809809C0(thisv, globalCtx);
    func_80980AD4(thisv, globalCtx);
    func_80980B68(thisv, globalCtx);
    func_80980BFC(thisv, globalCtx);
}

void func_80980D74(DemoGt* thisv, GlobalContext* globalCtx) {
    if (func_8097E704(globalCtx, 2, 3)) {
        thisv->updateMode = 10;
    }
}

void DemoGt_Update2(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097E824(thisv, 3);
    func_80980C90(thisv, globalCtx);
    func_80980D74(thisv, globalCtx);
}

void DemoGt_Update10(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097ED64(thisv, globalCtx, 3);
    func_80980C90(thisv, globalCtx);
}

void DemoGt_Draw3(DemoGt* thisv, GlobalContext* globalCtx) {
    GraphicsContext* gfxCtx = globalCtx->state.gfxCtx;
...
void func_80980F00_Init5(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;

    func_8097EE44(thisv, globalCtx, 3, 4, NULL);
}

void func_80980F58(DemoGt* thisv, GlobalContext* globalCtx) {
    u16 frames = globalCtx->csCtx.frames;

    if (frames == 244) {
        func_80078914(&thisv->dyna.actor.projectedPos, NA_SE_EV_TOWER_PARTS_BROKEN - SFX_FLAG);
    }
}

void func_80980F8C(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f sp58;
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
...
void func_8098103C(DemoGt* thisv, GlobalContext* globalCtx) {
...
void DemoGt_Update3(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097E824(thisv, 4);
    func_80980F58(thisv, globalCtx);
    func_8098103C(thisv, globalCtx);
}

void DemoGt_Update11(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097ED64(thisv, globalCtx, 4);
    func_80980F58(thisv, globalCtx);
}

void DemoGt_Update16(DemoGt* thisv, GlobalContext* globalCtx) {
    f32 temp = thisv->unk_172;

    thisv->unk_174 = (temp * ((kREG(64) * 0.001f) + 0.048f)) + (kREG(65) + 98.0f);
    thisv->unk_172 += thisv->unk_174;

    if (thisv->unk_172 > 0x4000) {
        thisv->unk_172 = 0x4000;
    }
}

void DemoGt_Draw4(DemoGt* thisv, GlobalContext* globalCtx2) {
    ...
    if (frames < 301) {
        ...
        sp76 = thisv->unk_172;
        sp70 = fabsf(sp76 * (std::numbers::pi_v<float> / 0x8000));
        sp6C = kREG(61);
...
void func_809813CC_Init6(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;

    func_8097EE44(thisv, globalCtx, 4, 5, NULL);
}

void func_80981424(DemoGt* thisv, GlobalContext* globalCtx) {
    u16 frames = globalCtx->csCtx.frames;
...
void func_80981458(DemoGt* thisv, GlobalContext* globalCtx) {
    s32 pad[3];
    Vec3f sp58;
    Vec3f dustPos;
    u16 frames = globalCtx->csCtx.frames;
...
void func_80981524(DemoGt* thisv, GlobalContext* globalCtx) {
...
void DemoGt_Update4(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097E824(thisv, 5);
    func_80981424(thisv, globalCtx);
    func_80981524(thisv, globalCtx);
}

void DemoGt_Update12(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097ED64(thisv, globalCtx, 5);
    func_80981424(thisv, globalCtx);
}

void DemoGt_Update17(DemoGt* thisv, GlobalContext* globalCtx) {
    f32 temp = thisv->unk_172;

    thisv->unk_174 = temp * ((kREG(66) * 0.001f) + 0.048f) + (kREG(67) + 50.0f);
    thisv->unk_172 += thisv->unk_174;
...
void DemoGt_Draw5(DemoGt* thisv, GlobalContext* globalCtx) {
    GraphicsContext* gfxCtx;
    s32 pad;
    s16 sp76;
    f32 sp70;
...
void func_809818A4_Init7(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;

    func_8097EE44(thisv, globalCtx, 5, 6, NULL);
}

void func_809818FC(DemoGt* thisv, GlobalContext* globalCtx) {
    u16 frames = globalCtx->csCtx.frames;
...
void func_80981930(DemoGt* thisv, GlobalContext* globalCtx) {
...
void DemoGt_Update5(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097E824(thisv, 6);
    func_809818FC(thisv, globalCtx);
    func_80981930(thisv, globalCtx);
}

void DemoGt_Update13(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097ED64(thisv, globalCtx, 6);
    func_809818FC(thisv, globalCtx);
}

void DemoGt_Update18(DemoGt* thisv, GlobalContext* globalCtx) {
    f32 temp = thisv->unk_172;

    thisv->unk_174 = (temp * ((kREG(68) * 0.001f) + 0.005f)) + (kREG(69) + 50.0f);
    thisv->unk_172 += thisv->unk_174;
...
void DemoGt_Draw6(DemoGt* thisv, GlobalContext* globalCtx) {
    DemoGt* this2 = thisv;
    ...
    sp74 = fabsf(sp78 * (std::numbers::pi_v<float> / 0x8000));
    sp70 = kREG(63);
    sp6E = kREG(60) + 0x4000;
    sp6C = kREG(60) + 0x4000;
    sp6C += 0x4000;
...
void func_80981C94_Init23(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;
    func_8097EE44(thisv, globalCtx, 6, 7, NULL);
}

void func_80981CEC(DemoGt* thisv, GlobalContext* globalCtx) {
    u16 frames = globalCtx->csCtx.frames;
...
void func_80981D20(DemoGt* thisv) {
    f32 temp = thisv->unk_172;

    thisv->unk_174 = temp * ((kREG(64) * 0.001f) + 0.048f) + (kREG(76) + 100.0f);
    thisv->unk_172 += thisv->unk_174;

    if (thisv->unk_172 > (s16)(kREG(80) + 0x4000)) {
        thisv->unk_172 = kREG(80) + 0x4000;
    }
}

void func_80981DC8(DemoGt* thisv, GlobalContext* globalCtx) {
    if (func_8097E704(globalCtx, 2, 7)) {
        thisv->updateMode = 0xE;
    }
}

void DemoGt_Update6(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097E824(thisv, 7);
    func_80981CEC(thisv, globalCtx);
    func_80981DC8(thisv, globalCtx);
}

void DemoGt_Update14(DemoGt* thisv, GlobalContext* globalCtx) {
    func_80981D20(thisv);
    func_8097ED64(thisv, globalCtx, 7);
    func_80981CEC(thisv, globalCtx);
}

void DemoGt_Draw7(DemoGt* thisv, GlobalContext* globalCtx) {
    DemoGt* this2 = thisv;
    GraphicsContext* gfxCtx = globalCtx->state.gfxCtx;
    s16 sp6E;
    f32 sp68;
    ...
    sp6E = this2->unk_172;
    sp68 = fabsf(sp6E * (std::numbers::pi_v<float> / 0x8000));
    sp64 = kREG(75);
    sp62 = kREG(74) + 0x7FEC;
    sp60 = kREG(74) + 0x7FEC;
    sp60 = sp60 + 0x4000;
...
void func_80982054_Init24(DemoGt* thisv, GlobalContext* globalCtx) {
    thisv->dyna.actor.scale.x *= 10.0f;
    thisv->dyna.actor.scale.y *= 10.0f;
    thisv->dyna.actor.scale.z *= 10.0f;
    func_8097EE44(thisv, globalCtx, 7, 8, NULL);
}

void func_809820AC(DemoGt* thisv, GlobalContext* globalCtx) {
    u16 frames = globalCtx->csCtx.frames;
...
void func_809820E0(DemoGt* thisv) {
    f32 temp = thisv->unk_172;

    thisv->unk_174 = (temp * ((kREG(64) * 0.001f) + 0.048f)) + (kREG(79) + 100.0f);
    thisv->unk_172 += thisv->unk_174;

    if (thisv->unk_172 > (s16)(kREG(81) + 0x4000)) {
        thisv->unk_172 = kREG(81) + 0x4000;
    }
}

void func_80982188(DemoGt* thisv, GlobalContext* globalCtx) {
    if (func_8097E704(globalCtx, 2, 9) != 0) {
        thisv->updateMode = 15;
    }
}

void DemoGt_Update7(DemoGt* thisv, GlobalContext* globalCtx) {
    func_8097E824(thisv, 9);
    func_809820AC(thisv, globalCtx);
    func_80982188(thisv, globalCtx);
}

void DemoGt_Update15(DemoGt* thisv, GlobalContext* globalCtx) {
    func_809820E0(thisv);
    func_8097ED64(thisv, globalCtx, 9);
    func_809820AC(thisv, globalCtx);
}

void DemoGt_Draw8(DemoGt* thisv, GlobalContext* globalCtx) {
    DemoGt* this2 = thisv;
    GraphicsContext* gfxCtx = globalCtx->state.gfxCtx;
    s16 sp6E;
    f32 sp68;
...
void DemoGt_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((thisv->updateMode < 0) || (thisv->updateMode >= 19) || (updateFunc = sUpdateFuncs[thisv->updateMode]) == NULL) {
        // "The main mode is strange!"
        osSyncPrintf(VT_FGCOL(RED) "メインモードがおかしい!!!!!!!!!!!!!!!!!!!!!!!!!\n" VT_RST);
        return;
    }

    updateFunc(thisv, globalCtx);
}
...
void DemoGt_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (thisv->dyna.actor.params) {
        case 0:
            func_8097EEA8_Init0(thisv, globalCtx);
            break;
        case 1:
            func_8097F904_Init1(thisv, globalCtx);
            break;
        case 2:
            func_80980110_Init2(thisv, globalCtx);
            break;
        case 5:
            func_80980F00_Init5(thisv, globalCtx);
            break;
        case 6:
            func_809813CC_Init6(thisv, globalCtx);
            break;
        case 7:
            func_809818A4_Init7(thisv, globalCtx);
            break;
        case 23:
            func_80981C94_Init23(thisv, globalCtx);
            break;
        case 24:
            func_80982054_Init24(thisv, globalCtx);
            break;
        default:
...
void DemoGt_Draw0(DemoGt* thisv, GlobalContext* globalCtx) {
}
...
void DemoGt_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((thisv->drawConfig < 0) || (thisv->drawConfig >= 9) || (drawFunc = sDrawFuncs[thisv->drawConfig]) == NULL) {
