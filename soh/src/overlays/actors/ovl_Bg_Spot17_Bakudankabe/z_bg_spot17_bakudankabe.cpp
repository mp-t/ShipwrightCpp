...
void func_808B6BC0(BgSpot17Bakudankabe* thisv, GlobalContext* globalCtx) {
    s32 pad[2];
    s32 i;
    Vec3f burstDepthY;
    Vec3f burstDepthX;
    ...
    for (i = 0; i < 20; i++) {
        ...
        burstDepthY.y = thisv->dyna.actor.world.pos.y + 30.0f + (i * 6.5f);
    ...
    Math_Vec3f_Copy(&burstDepthY, &thisv->dyna.actor.world.pos);
...
void BgSpot17Bakudankabe_Init(Actor* thisx, GlobalContext* globalCtx) {
    BgSpot17Bakudankabe* thisv = (BgSpot17Bakudankabe*)thisx;
    s32 pad;
...
void BgSpot17Bakudankabe_Update(Actor* thisx, GlobalContext* globalCtx) {
    BgSpot17Bakudankabe* thisv = (BgSpot17Bakudankabe*)thisx;
    if (thisv->dyna.actor.xzDistToPlayer < 650.0f && func_80033684(globalCtx, &thisv->dyna.actor) != NULL) {
        func_808B6BC0(thisv, globalCtx);
