...
CutsceneData D_80ABFB40[] = {
    ...
    CS_PLAYER_ACTION_LIST(3),
        CS_PLAYER_ACTION(0x0011, 0, 80, 0x0000, 0x8000, 0x0000, 0, UINT32_C(-40), 1400, 0, UINT32_C(-40), 1400, 0.0f, 0.0f, 1.401298464324817e-45f),
        CS_PLAYER_ACTION(0x0012, 80, 201, 0x0000, 0x8000, 0x0000, 0, UINT32_C(-40), 1400, 0, UINT32_C(-40), 1400, 0.0f, 0.0f, 1.401298464324817e-45f),
        CS_PLAYER_ACTION(0x0005, 201, 662, 0x0000, 0x8000, 0x0000, 0, UINT32_C(-40), 1400, 0, UINT32_C(-40), 1400, 0.0f, 0.0f, 1.401298464324817e-45f),
    CS_MISC_LIST(1),
