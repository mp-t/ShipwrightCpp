...
static CutsceneData D_80A88164[] = {
    ...
    CS_PLAYER_ACTION_LIST(4),
        CS_PLAYER_ACTION(0x0005, 0, 240, 0x0000, 0x4000, 0x0000, UINT32_C(-1732), 52, UINT32_C(-44), UINT32_C(-1732), 52, UINT32_C(-44), 1.1393037e-29f, 0.0f, 1.4e-45f),
        CS_PLAYER_ACTION(0x0003, 240, 255, 0x0000, 0x4000, 0x0000, UINT32_C(-1732), 52, UINT32_C(-44), UINT32_C(-1732), 52, UINT32_C(-44), 1.1393037e-29f, 0.0f, 1.4e-45f),
        CS_PLAYER_ACTION(0x0006, 255, 285, 0x0000, 0x4000, 0x0000, UINT32_C(-1732), 52, UINT32_C(-44), UINT32_C(-1732), 52, UINT32_C(-44), 1.1393037e-29f, 0.0f, 1.4e-45f),
        CS_PLAYER_ACTION(0x0020, 285, 300, 0x0000, 0xC000, 0x0000, UINT32_C(-1732), 52, UINT32_C(-44), UINT32_C(-1537), 109, UINT32_C(-44), 1.1393037e-29f, 0.0f, 1.4e-45f),
    CS_NPC_ACTION_LIST(68, 4),
        CS_NPC_ACTION(0x0001, 0, 234, 0x0000, 0x4000, 0x0000, UINT32_C(-1665), 52, UINT32_C(-44), UINT32_C(-1665), 52, UINT32_C(-44), 1.1393037e-29f, 0.0f, 1.4e-45f),
        CS_NPC_ACTION(0x0002, 234, 241, 0x41F8, 0x0000, 0x0000, UINT32_C(-1665), 52, UINT32_C(-44), UINT32_C(-1603), 130, UINT32_C(-47), 8.857142f, 11.142858f, -8.857142f),
        CS_NPC_ACTION(0x0002, 241, 280, 0x4031, 0x0000, 0x0000, UINT32_C(-1603), 130, UINT32_C(-47), UINT32_C(-549), 130, UINT32_C(-52), 27.02564f, 0.0f, -27.02564f),
        CS_NPC_ACTION(0x0003, 280, 300, 0x0000, 0x0000, 0x0000, UINT32_C(-549), 130, UINT32_C(-52), UINT32_C(-549), 130, UINT32_C(-52), 0.0f, 0.0f, 0.0f),
    ...
    CS_NPC_ACTION_LIST(69, 3),
        CS_NPC_ACTION(0x0001, 0, 90, 0x0000, 0x0000, 0x0000, 0, UINT32_C(-33), 9, 0, UINT32_C(-33), 9, 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0002, 90, 330, 0x0000, 0x0000, 0x0000, 0, UINT32_C(-33), 9, 0, UINT32_C(-62), 22, 0.0f, -0.12083333f, 0.0f),
        CS_NPC_ACTION(0x0003, 330, 380, 0x0000, 0x0000, 0x0000, 0, UINT32_C(-62), 22, 0, UINT32_C(-62), 22, 0.0f, 0.0f, 0.0f),
    CS_MISC_LIST(1),
    ...
    CS_PLAYER_ACTION_LIST(1),
        CS_PLAYER_ACTION(0x0035, 300, 1629, 0x0000, 0x0000, 0x0000, UINT32_C(-1630), 52, UINT32_C(-52), UINT32_C(-1630), 52, UINT32_C(-52), 0.0f, 0.0f, 0.0f),
    ...
    CS_NPC_ACTION_LIST(62, 1),
        CS_NPC_ACTION(0x0001, 305, 494, 0x0000, 0x0000, 0x0000, UINT32_C(-1399), 452, UINT32_C(-53), UINT32_C(-1399), 452, UINT32_C(-53), 0.0f, 0.0f, 0.0f),
    CS_END(),
};
// clang-format on
