...
CutsceneData D_80B4C5D0[] = {
    ...
    CS_PLAYER_ACTION_LIST(3),
        CS_PLAYER_ACTION(0x0005, 400, 1211, 0x0000, 0xC000, 0x0000, UINT32_C(-422), 84, 1, UINT32_C(-422), 84, 1, 1.1266861702801002e-29f, 0.0f, 1.401298464324817e-45f),
        CS_PLAYER_ACTION(0x0001, 1211, 1241, 0x0000, 0xC000, 0x0000, UINT32_C(-422), 84, 1, UINT32_C(-483), 84, 0, 1.1266861702801002e-29f, 0.0f, 1.401298464324817e-45f),
        CS_PLAYER_ACTION(0x0029, 1241, 1311, 0x0000, 0xC000, 0x0000, UINT32_C(-483), 84, 0, UINT32_C(-483), 84, 0, 1.1266861702801002e-29f, 0.0f, 1.401298464324817e-45f),
    CS_NPC_ACTION_LIST(18, 1),
        CS_NPC_ACTION(0x0007, 1170, 1316, 0x7477, 0x0000, 0x0000, UINT32_C(-485), 84, 0, UINT32_C(-469), 85, UINT32_C(-55), 0.10958904f, 0.006849315f, -0.10958904f),
    ...
    CS_NPC_ACTION_LIST(16, 3),
        CS_NPC_ACTION(0x0009, 1220, 1310, 0x8000, 0x0000, 0x0000, UINT32_C(-890), 90, 150, UINT32_C(-890), 90, 0, 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x000A, 1310, 1449, 0x0000, 0x0000, 0x0000, UINT32_C(-890), 90, 0, UINT32_C(-890), 90, 0, 0.0f, 0.0f, 0.0f),
        CS_NPC_ACTION(0x0004, 1449, 1457, 0x0000, 0x0000, 0x0000, UINT32_C(-890), 90, 0, UINT32_C(-890), 90, 0, 0.0f, 0.0f, 0.0f),
    CS_MISC_LIST(1),
    ...
    CS_NPC_ACTION_LIST(29, 1),
        CS_NPC_ACTION(0x0002, 330, 763, 0x0000, 0x0000, 0x0000, UINT32_C(-1250), 150, 0, UINT32_C(-1250), 150, 0, 0.0f, 0.0f, 0.0f),
