...
View* View_New(GraphicsContext* gfxCtx) {
    View* view = static_cast<View*>(SystemArena_MallocDebug(sizeof(View), "../z_view.c", 285));
...
void func_800AA460(View* view, f32 fovy, f32 near_, f32 far_) {
    view->fovy = fovy;
    view->zNear = near_;
    //view->zNear = -30;
    view->zFar = far_;
...
void func_800AA48C(View* view, f32* fovy, f32* near_, f32* far_) {
    *fovy = view->fovy;
    *near_ = view->zNear;
    *far_ = view->zFar;
}

void func_800AA4A8(View* view, f32 fovy, f32 near_, f32 far_) {
    view->fovy = fovy;
    view->zNear = near_;
    //view->zNear = -30;
    view->zFar = far_;
...
void func_800AA4E0(View* view, f32* fovy, f32* near_, f32* far_) {
    *fovy = view->fovy;
    *near_ = view->zNear;
    *far_ = view->zFar;
}
...
s32 func_800AAA9C(View* view) {
    ...
    vp = static_cast<Vp*>( Graph_Alloc(gfxCtx, sizeof(Vp)) );
    ...
    projection = static_cast<Mtx*>( Graph_Alloc(gfxCtx, sizeof(Mtx)) );
    ...
    if (QREG(88) & 1) {
        ...
        osSyncPrintf("fovy %f near_ %f far_ %f scale %f aspect %f normal %08x\n", view->fovy, view->zNear, view->zFar,
    ...
    viewing = static_cast<Mtx*>( Graph_Alloc(gfxCtx, sizeof(Mtx)) );
