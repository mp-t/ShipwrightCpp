...
Gfx* Gfx_SetFog(Gfx* gfx, s32 r, s32 g, s32 b, s32 a, s32 near_, s32 far_) {
    if (far_ == near_) {
        far_++;
    }

    ASSERT(near_ != far_, "n != f", "../z_rcp.c", 1155);
    ...
    if (near_ >= 1000) {
        ...
        gSPFogPosition(gfx++, near_, far_);
    }

    return gfx;
}

Gfx* Gfx_SetFogWithSync(Gfx* gfx, s32 r, s32 g, s32 b, s32 a, s32 near_, s32 far_) {
    if (far_ == near_) {
        far_++;
    }
    ASSERT(near_ != far_, "n != f", "../z_rcp.c", 1187);
...
Gfx* Gfx_SetFog2(Gfx* gfx, s32 r, s32 g, s32 b, s32 a, s32 near_, s32 far_) {
    return Gfx_SetFog(gfx, r, g, b, a, near_, far_);
}
...
Gfx* Gfx_BranchTexScroll(Gfx** gfxp, u32 x, u32 y, s32 width, s32 height) {
    Gfx* displayList = static_cast<Gfx*>(Graph_DlistAlloc(gfxp, 3 * sizeof(Gfx)));
...
Gfx* Gfx_TexScroll(GraphicsContext* gfxCtx, u32 x, u32 y, s32 width, s32 height) {
    Gfx* displayList = static_cast<Gfx*>(Graph_Alloc(gfxCtx, 3 * sizeof(Gfx)));
...
Gfx* Gfx_TwoTexScroll(GraphicsContext* gfxCtx, s32 tile1, u32 x1, u32 y1, s32 width1, s32 height1, s32 tile2, u32 x2,
    ...
    Gfx* displayList = static_cast<Gfx*>(Graph_Alloc(gfxCtx, 5 * sizeof(Gfx)));
...
Gfx* Gfx_TwoTexScrollEnvColor(GraphicsContext* gfxCtx, s32 tile1, u32 x1, u32 y1, s32 width1, s32 height1, s32 tile2,
    ...
    Gfx* displayList = static_cast<Gfx*>(Graph_Alloc(gfxCtx, 6 * sizeof(Gfx)));
