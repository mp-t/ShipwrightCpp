...
static void RunFrame()
{
    ...
    while (runFrameContext.nextOvl)
    {
        ...
        runFrameContext.gameState = static_cast<GameState*>(SystemArena_MallocDebug(size, "../graph.c", 1196));
        ...
        while (GameState_IsRunning(runFrameContext.gameState))
        {
            ...
            samples_left = AudioPlayer_Buffered();
            num_audio_samples = samples_left < AudioPlayer_GetDesiredBuffered() ? SAMPLES_HIGH : SAMPLES_LOW;
