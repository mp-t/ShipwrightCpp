...
// Init
void func_800ACE70(struct_801664F0* thisx) {
    thisx->type = 0;
...
// Destroy
void func_800ACE90(struct_801664F0* thisx) {
}

// Draw
void func_800ACE98(struct_801664F0* thisx, Gfx** gfxp) {
    Gfx* gfx = *gfxp;
    ...
    switch (thisx->type) {
        case 1:
            ...
            break;
        case 2:
            gDPSetColor(gfx++, G_SETPRIMCOLOR, thisx->color.rgba);
            gSPDisplayList(gfx++, D_8012AC58);
            break;
        case 3:
            gDPSetColor(gfx++, G_SETBLENDCOLOR, thisx->color.rgba);
            gSPDisplayList(gfx++, D_8012AC00);
            break;
        case 4:
            gDPSetColor(gfx++, G_SETFOGCOLOR, thisx->color.rgba);
