...
using KaleidoScopeFunc = void (*)(GlobalContext*);
KaleidoScopeFunc sKaleidoScopeUpdateFunc;
KaleidoScopeFunc sKaleidoScopeDrawFunc;
...
void KaleidoScopeCall_Init(GlobalContext* globalCtx) {
    ...
    sKaleidoScopeUpdateFunc = static_cast<KaleidoScopeFunc>(KaleidoManager_GetRamAddr(KaleidoScope_Update));
    sKaleidoScopeDrawFunc = static_cast<KaleidoScopeFunc>(KaleidoManager_GetRamAddr(KaleidoScope_Draw));
