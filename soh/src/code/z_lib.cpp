...
/**
 * Changes pValue by step towards target. If thisv step is more than fraction of the remaining distance, step by that
...
/**
 * Changes pValue by step towards target angle in degrees. If thisv step is more than fraction of the remaining distance,
...
/**
 * Changes pValue by step towards target. If thisv step is more than 1/scale of the remaining distance, step by that
 * instead, with a minimum step of minStep. Returns remaining distance to target.
 */
