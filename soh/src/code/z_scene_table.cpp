...
const void* gDCEntranceTextures[] = {
    gDCDayEntranceTex,
    gDCNightEntranceTex,
};
const void* sDCLavaFloorTextures[] = {
...
void func_80099878(GlobalContext* globalCtx) {
    u32 gameplayFrames;
    s32 pad;
    Gfx* displayListHead = static_cast<Gfx*>( Graph_Alloc(globalCtx->state.gfxCtx, 2 * sizeof(Gfx[3])) );
...
void func_80099BD8(GlobalContext* globalCtx) {
    f32 temp;
    Gfx* displayListHead = static_cast<Gfx*>( Graph_Alloc(globalCtx->state.gfxCtx, 18 * sizeof(Gfx)) );
...
const void* sThievesHideoutEntranceTextures[] = {
...
const void* sIceCavernEntranceTextures[] = {
...
const void* sGTGEntranceTextures[] = {
    gGTGDayEntranceTex,
...
Gfx* Gfx_TwoTexScrollPrimColor(GraphicsContext* gfxCtx, s32 tile1, u32 x1, u32 y1, s32 width1, s32 height1, s32 tile2,
    ...
    Gfx* displayList = static_cast<Gfx*>( Graph_Alloc(gfxCtx, 10 * sizeof(Gfx)) );
...
const void* sLonLonHouseEntranceTextures[] = {
...
const void* sGuardHouseView2Textures[] = {
    gGuardHouseOutSideView1DayTex,
    gGuardHouseOutSideView1NightTex,
};
const void* sGuardHouseView1Textures[] = {
...
const void* sForestTempleEntranceTextures[] = {
...
const void* sSpiritTempleEntranceTextures[] = {
...
void func_8009DA30(GlobalContext* globalCtx) {
    ...
    displayListHead = static_cast<Gfx*>( Graph_Alloc(globalCtx->state.gfxCtx, 3 * sizeof(Gfx)) );
...
const void* sKakarikoWindowTextures[] = {
...
void func_8009E0B8(GlobalContext* globalCtx) {
    ...
    spA3 = 128;
    spA0 = 500;
    displayListHead = static_cast<Gfx*>( Graph_Alloc(globalCtx->state.gfxCtx, 6 * sizeof(Gfx)) );
...
const void* sZorasDomainEntranceTextures[] = {
...
void func_8009F5D4(GlobalContext* globalCtx) {
    Gfx* displayListHead = static_cast<Gfx*>( Graph_Alloc(globalCtx->state.gfxCtx, 3 * sizeof(Gfx)) );
...
const void* sGoronCityEntranceTextures[] = {
...
const void* sLonLonRanchWindowTextures[] = {
...
void func_8009FE58(GlobalContext* globalCtx) {
    ...
    if (FrameAdvance_IsEnabled(globalCtx) != true) {
        ...
        if (globalCtx->pauseCtx.state == 0) {
            func_800AA76C(&globalCtx->view, ((360.00018f / 65535.0f) * (std::numbers::pi_v<float> / 180.0f)) * temp * Math_CosS(D_8012A39C),
                          ((360.00018f / 65535.0f) * (std::numbers::pi_v<float> / 180.0f)) * temp * Math_SinS(D_8012A39C),
                          ((360.00018f / 65535.0f) * (std::numbers::pi_v<float> / 180.0f)) * temp * Math_SinS(D_8012A3A0));
