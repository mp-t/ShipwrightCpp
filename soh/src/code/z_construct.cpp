...
void func_801109B0(GlobalContext* globalCtx) {
    ...
    interfaceCtx->parameterSegment = static_cast<u8*>( GameState_Alloc(&globalCtx->state, parameterSize, "../z_construct.c", 159) );
    ...
    interfaceCtx->doActionSegment = static_cast<u8*>( GameState_Alloc(&globalCtx->state, 0x480, "../z_construct.c", 166) );
    ...
    interfaceCtx->iconItemSegment = static_cast<u8*>( GameState_Alloc(&globalCtx->state, 0x4000, "../z_construct.c", 190) );
