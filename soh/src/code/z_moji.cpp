 ...
 * For example thisv works with the render mode used in `GfxPrint_Setup`,
...
void Moji_DrawString(GraphicsContext* gfxCtx, const char* str) {
    ...
    gDPLoadTextureBlock_4b(POLY_OPA_DISP++, reinterpret_cast<const void*>(gMojiFontTex), G_IM_FMT_CI, TEX_CHAR_COLS * TEX_CHAR_WIDTH,
