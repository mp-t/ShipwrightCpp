...
const char* D_8012CEF8 = GFXP_HIRAGANA "ﾓｳﾊｲﾘﾏｾﾝ";
char        D_8012CEFC[] = GFXP_HIRAGANA "ﾄｳﾛｸ   ﾃﾝﾒ";
char        D_8012CF00[] = GFXP_HIRAGANA "ﾍﾝｺｳ   /  ";
...
void* DbCamera_SetTextValue(s16 value, char* str, u8 endIdx) {
    char* strIter;
    char sign;
    ...
    if (dbCamera->unk_00 == 1) {
        ...
        if (CHECK_BTN_ALL(sGlobalCtx->state.input[2].cur.button, BTN_CRIGHT) &&
            ...
            if (dbCamera->sub.unkIdx == 0x80) {
                ...
                D_8012CEFC[10] = (dbCamera->sub.nPoints / 10) + '0';
                D_8012CEFC[11] = (dbCamera->sub.nPoints % 10) + '0';
                func_8006376C(0xF, 0x1A, 1, D_8012CEFC);
            } else {
                D_8012CF00[10] = ((dbCamera->sub.unkIdx + 1) / 10) + '0';
                D_8012CF00[11] = ((dbCamera->sub.unkIdx + 1) % 10) + '0';
                D_8012CF00[13] = ((dbCamera->sub.nPoints - 1) / 10) + '0';
                D_8012CF00[14] = ((dbCamera->sub.nPoints - 1) % 10) + '0';
                func_8006376C(0xF, 0x1A, 1, D_8012CF00);
            }
...
char DbCamera_InitCut(s32 idx, DbCameraSub* sub) {
    ...
    sDbCameraCuts[idx].lookAt = static_cast<CutsceneCameraPoint*>(DebugArena_MallocDebug(i, "../db_camera.c", 2748));
    ...
    sDbCameraCuts[idx].position = static_cast<CutsceneCameraPoint*>(DebugArena_MallocDebug(i, "../db_camera.c", 2754));
...
s32 DbCamera_LoadCallback(char* c) {
    ...
    for (i = 0; i < ARRAY_COUNT(sDbCameraCuts) - 1; i++) {
        if (sDbCameraCuts[i].letter != '?') {
            ...
            sDbCameraCuts[i].lookAt = static_cast<CutsceneCameraPoint*>(DebugArena_MallocDebug(ALIGN32(size), "../db_camera.c", 2844));
            ...
            sDbCameraCuts[i].position = static_cast<CutsceneCameraPoint*>(DebugArena_MallocDebug(ALIGN32(size), "../db_camera.c", 2855));
            ...
            switch (dbCamera->sub.demoCtrlMenu) {
                ...
                case DEMO_CTRL_MENU(ACTION_CLEAR, MENU_INFO): {
                    if ((1 << sCurFileIdx) & sMempakFiles) {
                        ...
                        func_8006376C(0xA, 7, 5, D_8012CF84);
                ...
                case DEMO_CTRL_MENU(ACTION_CLEAR, MENU_CALLBACK): {
                    D_8012CF84[9] = sCurFileIdx + 'A';
                    func_8006376C(0xC, 7, 5, D_8012CF84);
                ...
                case DEMO_CTRL_MENU(ACTION_CLEAR, MENU_ERROR): {
                    dbCamera->sub.demoCtrlToggleSwitch ^= 1;
                    D_8012CF84[9] = sCurFileIdx + 'A';
                    switch ((dbCamera->sub.demoCtrlMenu / 100))
                    {
                    case 1:
                        func_8006376C(0xD, 7, 5, D_8012CF04);
                        break;
                    case 2:
                        func_8006376C(0xD, 7, 5, D_8012CF08);
                        break;
                    case 3:
                        func_8006376C(0xD, 7, 5, D_8012CF0C);
                        break;
                    }
